...
import { Input, Button, Card, Spinner, ExpandableSection, IconSettings } from '@salesforce/design-system-react';
import ky from 'ky';
...
function App() {
  ...
  const handleSubmit = async (_: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    setConversation([{question: query, response: await response.text()}, ...conversation])
    setQuery('')
  }
